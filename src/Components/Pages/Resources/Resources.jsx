                  ...
                  <div>
                    <div className=" w-auto  bg-white border border-gray-200 rounded-lg shadow p-2 ">
                      ...
                      <div className="mt-2 mb-2">
                        <label htmlFor="minmax-range" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Educational Level</label>
                      ...
                      <div>
                        <label htmlFor="minmax-range" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Divission</label>
                        <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                          <option >Choose a country</option>
                          <option value="US">United States</option>
                          <option value="CA">Canada</option>
                      ...
                      <div>
                        ...
                        <h3 className="mb-4 font-semibold text-gray-900 dark:text-white">Chose Subject</h3>
